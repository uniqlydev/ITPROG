...
INSERT INTO `Customer` (`id`, `uname`, `main`, `sides`, `drinks`, `total`, `discount`, `date`, `mquan`, `squan`, `dquan`, `priceOfMain`, `priceOfSide`, `priceOfDrink`) VALUES
(1, 'Matthew', 'Steak', 'Fries', 'Water', 1000, 0, '2023-07-27', 1, 1, 1, 500, 400, 100);
...
(1, 'Steak', 900, 'https://lh3.googleusercontent.com/hi8ldRrhDDEWCOxtwFFt0QpepcGROeK76FWsMB_OiMNGxc9CDa9rVEsyu-i5PZbQk_fvmmLg09Ae0dDRJ6r3Nyo', 'temporary', 100, 'M'),
...
(10, 'gelo', 1, 'https://aphrodite.gmanetwork.com/entertainment/articles/900_675_1__20190620095403.jpg', 'sarap', 1, 'M');
